from Models import Utente,Cliente,Amministratore,Credenziali,CertificatoMedico,SalaPesi,Corso,Pagamento,Palestra,FasciaOraria,Ingresso,Abbonamento,Statistica,Prenotazione,PrenotazioneCorso,PrenotazioneSalaPesi
